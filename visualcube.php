...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<meta name="copyright"          content="Copyright © 2000-2008 Conrad Rider"/>
	...
	<body>
		...
		<div id="footer">
			Copyright &copy; 2009 <a href="http://www.crider.co.uk">Conrad Rider</a>.
...
if($bg) $cube .= "\t<rect fill='#$bg' x='$ox' y='$oy' width='$vw' height='$vh'/>\n";
		...
		if($DEBUG) echo $cube;
			...
			if($ENABLE_CACHE && strlen($img) < $CACHE_IMG_SIZE_LIMIT){
