...
function makeFaceStickers(face, options) {
    ...
    for (var row = 0; row <= options.cubeSize; row++) {
        var _loop_1 = function (col) {
            ...
            sticker = math_1.translate(sticker, options.centerTranslation);
            ...
            sticker = math_1.translate(sticker, options.zPosition);
            // Finally project the 3D points onto 2D
            sticker = math_1.project(sticker, options.zPosition[2]);
